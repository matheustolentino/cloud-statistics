...
\usepackage{booktabs}
\usepackage{multirow}
\usepackage[flushleft]{threeparttable} % Add this line for table notes

\usepackage{xcolor}
\usepackage{easyReview}
\definecolor{mycustomcolor}{RGB}{255, 200, 0}
