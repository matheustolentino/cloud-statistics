...
It is widely recognized that cloud radiative effect can change thermodinamic conditions of the atmosphere (\citep{XXX} cite somenthing). From this perspective, this section makes a comparison between clear sky and cloudly thermodinamic profiles for diferent cloud types.

Temperature and humidity profiles used as baselines were those collected during clear sky condition, and are shown in Figure \ref{fig:temp_no_cloud}. This figure can easily identify cold and warm regimes, where cold regimes spans between winter and spring, while warm regimes spans between summer and autumn. This annual variablility was also observed by \cite{Nokomova and PirloagaXXX}, howevever, higher temperature values experienced by our station is only closely resembling those reported by \cite{PirloagaXXX}, as both stations are geographic located in warm regions. In our case, mean surface temperature faces a value of XXX $\pm$ XXX in summer, by contrast with XXX $\pm$ XXX in winter. For monthly averange humidity profiles, the values here appear slightly higher than those documented by \cite{NokomovaXXX}, with surface averange of XXX $\pm$ XXX in summer and XXX $\pm$ XXX in winter
