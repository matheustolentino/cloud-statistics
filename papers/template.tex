...
Next, a fraction of the observed liquid hydrometeors can be redistributed between liquid and mixed phase clouds. For these two cloud types, discarding rain events, and regarding only single layer clouds, their LWP frequency histogram is shown in Figure XXX. Overall, both liquid and mixed-phase clouds appear to contain similar amounts of water. This agreement between both clouds types could be assigned to the incapability of the assortment algorithm to separated clouds by a time interval defined by where does the cloud begin and where does it end. Hence, we can be considering liquid and mixed phase profiles inside the same cloud as as a whole. It is worthy to note clouds identifyed were done profiles to profile, at every 30\,s, which is the Cloudnet time grid.  
