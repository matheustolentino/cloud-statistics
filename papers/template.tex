...
\begin{figure}[htbp]
      \centering
      \includegraphics[width=1.\textwidth]{figures/Granada_station2.png}
...
\begin{figure}[htbp]
      \centering
      \includegraphics[width=1.\textwidth]{figures/chirp_intervals.png}
...
\begin{figure}[htbp]
      \centering
      \includegraphics[width=1.\textwidth]{figures/cloudnet_products.png}
...
%\begin{figure}[htbp]
%      \centering
%      \includegraphics[width=1.\textwidth]{figures/mwr_time_series_RH.png}
%      \caption{Should change figure - Reflectivity, Att. backscatter coeff and LWP}
%      \label{fig:product_vs_intrument}
%\end{figure}
